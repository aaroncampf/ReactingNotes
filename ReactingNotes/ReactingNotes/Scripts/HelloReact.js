...
var ContactDisplay = (function (_super) {
    ...
    function ContactDisplay() {
        ...
        this.ViewNotes = function (Current) {
            ...
            return (React.createElement("table", {"id": "QuoteDisplay-" + _this.props.ID, "className": "table-striped table-bordered"}, React.createElement("tbody", null, React.createElement("tr", null, React.createElement("td", {"colSpan": 5, "style": { "text-align": "center" }}, React.createElement("h3", null, _this.props.Name))), Rows)));
        };
    }
